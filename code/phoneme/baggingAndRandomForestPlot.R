...
load("../../dataset/phonemeResults/baggingPhoneme.Rdata")
load("../../dataset/phonemeResults/randomForestPhoneme.Rdata")

# Different depths
printfig("baggingAndRFPhoneme", NOPRINT)
