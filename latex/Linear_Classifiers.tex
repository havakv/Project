...
A test set was also generated using \Sexpr{Ntest} realizations from each group. The two methods performed almost the same. LDA had a misclassification error of \Sexpr{mceLda}, and logistic regression had \Sexpr{mceLog}. This is very close to the optimal MCE of \Sexpr{mceLdaopt}.
\\
%
\begin{figure}[h!]
\begin{center}
