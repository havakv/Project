...
LDA and Fisher's linear discriminant are in principle the same method, but they differ in the whay they are derived. Both will be showed in this section. The arguments are largely based on \cite{bishop} and \cite{modstat}, so no further references to these books will be made. 
