...
A common way to view the goal of classification and regression problems is to find 
\begin{align}
  F^* = \argmin_F \E_{Y, X}[L(Y,F(X))] = \argmin_F \E_{X}[ \E_Y (L(Y,F(X))|X) ].
\end{align}


Another way to view boosting is
