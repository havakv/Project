...
\\
Adaboost.M1 was created in (1997) \todo{ref} and \colorbox{yellow}{some history}. Hastie et al. \cite{modstat} describes it as the ''the most popular boosting algorithm''. Only the two class case will be discussed here, but it generalizes easily. 
